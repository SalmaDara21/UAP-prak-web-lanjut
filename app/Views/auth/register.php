<?= $this->extend('auth/layout/auth_app');?>
...
<div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block "><img class="img-fluid" src="https://raw.githubusercontent.com/NaufallHilal/test/main/andriyko-podilnyk-bdmdX_XMcV4-unsplash.jpg"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email" id="exampleInputEmail"
